        ...
        <div className="flex-1">
          ...
          <div className="flex gap-3">
            <Link 
              ...
              className="bg-gradient-to-br from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-mono text-sm px-4 py-2 rounded-lg transition-all duration-200 flex items-center gap-2"
            >
